...
export const metadata: Metadata = {
  ...
  description: "Hey! I'm Abhishek, a Software Engineer focused on high-performance web applications.",
  keywords: ['Software Engineer', 'Abhishek Garg', 'theabgarg', 'Web Developer', 'React', 'Next.js', 'Golang'],
