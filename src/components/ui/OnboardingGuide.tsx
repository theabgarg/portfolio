    ...
    if (step === 'landing') {
        return (
            <div
                ...
                style={{
                    background: 'radial-gradient(ellipse at center, rgba(10,10,10,0.92) 0%, rgba(0,0,0,0.98) 100%)',
                    opacity: visible ? 1 : 0,
                }}
            >
                <div className="text-center max-w-md px-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button
                            ...
                            style={{
                                background: 'linear-gradient(135deg, rgba(244, 208, 63, 0.15) 0%, rgba(255, 179, 71, 0.1) 100%)',
                                border: '1px solid rgba(244, 208, 63, 0.3)',
                                color: '#F4D03F',
                            }}
                            onMouseEnter={(e) => {
                                e.currentTarget.style.background = 'linear-gradient(135deg, rgba(244, 208, 63, 0.25) 0%, rgba(255, 179, 71, 0.18) 100%)';
                                e.currentTarget.style.borderColor = 'rgba(244, 208, 63, 0.5)';
                                e.currentTarget.style.transform = 'translateY(-1px)';
                            }}
                            onMouseLeave={(e) => {
                                e.currentTarget.style.background = 'linear-gradient(135deg, rgba(244, 208, 63, 0.15) 0%, rgba(255, 179, 71, 0.1) 100%)';
