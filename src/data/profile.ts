...
export const PROFILE = {
    ...
    resumeUrl: 'https://drive.google.com/file/d/1OT9HUP44F-7CoGmz1KzFBlX0Lye4fCoS/view?usp=sharing',
    heroSummary: 'Results-driven Software Engineer with over 5+ years of experience in architecting and optimizing high-performance web applications.',
    aboutIntro: "I build high-performance products with React.js, Next.js, Node.js, and Golang.",
    about: [
        'On the frontend, I design scalable interfaces with clean state flow, real-time updates, and consistent component architecture.',
        'On the backend, I build resilient Golang services and APIs for integrations, data-heavy workflows, and reliability-critical features.',
        'I enjoy solving complex engineering challenges where performance, product impact, and maintainability all matter.',
    ],
    socialLinks: [
...
export const EXPERIENCE: ExperienceItem[] = [
    {
        ...
        description: 'SMC Global provides end-to-end investment and trading solutions.',
        responsibilities: [
    ...
    },
    {
        ...
        description: 'National Informatics Centre is the premier ICT organization of the Government of India.',
        responsibilities: [
    ...
    },
    {
        ...
        description: 'NamaSYS is a service-based company delivering software solutions across domains.',
        responsibilities: [
